...
namespace Sharphound.Runtime
{
    public class OutputWriter
    {
        ...
        private string ZipFiles()
        {
            ...
            var resolvedFileName = _context.ResolveFileName(filename, "bin", true);

            if (File.Exists(resolvedFileName))
                resolvedFileName = _context.ResolveFileName(Path.GetRandomFileName(), "bin", true);
            ...
            fileList.AddRange(new[]
            {
                ...
                CompStatusWriter.computerStatusCSV
            });
